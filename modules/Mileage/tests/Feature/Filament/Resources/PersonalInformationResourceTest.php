...
beforeEach(function () {
    ...
    if (! Route::getRoutes()->getByName('filament.mileage-panel.resources.personal-information.index')) {
        Route::get('/personal-information', fn () => '')->name('filament.mileage-panel.resources.personal-information.index');
    }
...
it('can render the personal information page', function () {
...
it('has table columns for personal information', function (string $column) {
    livewire(ManagePersonalInformation::class)
        ->assertTableColumnExists($column);
})->with(['street', 'city', 'iban', 'car_license_plate1']);

it('displays edit and delete actions on table', function () {
    livewire(ManagePersonalInformation::class)
