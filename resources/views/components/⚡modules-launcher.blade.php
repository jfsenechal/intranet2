...
>
    ...
    <div
        ...
        class="fixed inset-4 z-50 mx-auto max-w-2xl overflow-y-auto rounded-2xl bg-white p-6 shadow-2xl ring-1 ring-gray-200 sm:inset-auto sm:left-1/2 sm:top-1/2 sm:-translate-x-1/2 sm:-translate-y-1/2 sm:max-h-[85vh] dark:bg-gray-900 dark:ring-gray-700"
        style="display: none;"
    >
        {{-- Header --}}
